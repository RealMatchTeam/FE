...
export default function CollaborationSummaryBar({
  ...
  return (
    <div className="w-full h-[64px] bg-white flex items-center gap-3 px-3.5">
      ...
      {/* 텍스트 영역 */}
      <div className="min-w-0 flex-1 flex flex-col justify-center gap-[2px]">
        <div className="flex items-center gap-2">
          <span className="bg-[#E6E6F3] text-[#6666E5] text-[10px] leading-[14px] px-[6px] py-[2px] rounded-[6px] shrink-0">
            협업 중
          </span>

          <div className="min-w-0 text-[14px] leading-[20px] text-[#111] font-semibold truncate">
            {title}
          </div>
        </div>
