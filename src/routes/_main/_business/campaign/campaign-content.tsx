                ...
                <div className="flex flex-col gap-5">
                    ...
                    >
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="text-[13px] font-semibold text-[#9B9BA1]">
                                    설명
                                </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <CampaignInfoGroup label="협찬품">
                            <div className="w-full p-4 bg-white border border-gray-100 rounded-lg text-[14px] flex justify-between items-center">
                                글로우 크림 1개
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <div className="flex-1 p-4 bg-white border border-gray-100 rounded-lg text-[14px]">
                                2025년 1월 20일
                            </div>
                    ...
                    <CampaignInfoGroup
                        ...
                        right={<img src={editIcon} alt="edit" className="w-4 h-4" />}
                    >
                        <div className="w-full p-4 bg-white border border-gray-100 rounded-lg text-[14px] text-[#9B9BA1]">
                            기타 협의 사항을 입력해주세요
                        </div>
                    </CampaignInfoGroup>
                </div>
...
function ContentItem({ label, value }: { label: string; value: string }) {
    return (
        <div className="flex flex-col gap-1">
            <p className="text-[13px] font-semibold text-[#9B9BA1]">{label}</p>
            <div className="p-4 bg-white border border-gray-100 rounded-lg text-[14px] flex justify-between items-center">
                {value}
                <img src={arrowRightIcon} alt="arrow" className="w-4 h-4" />
            </div>
        </div>
